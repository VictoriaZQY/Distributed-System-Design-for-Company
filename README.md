...
Given the current conditions of the company: a rural, large-sized department recruitment company with a single office and no IT department, the solution must prioritize low-bandwidth dependency, ease of implementation, and operational reliability.
